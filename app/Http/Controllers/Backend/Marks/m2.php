...
class MarksController extends Controller
{
	...
	StudentMarks::where('year_id',$request->year_id)->where('periode_id',$periode_id)->where('class_id',$request->class_id)->where('assign_subject_id',$request->assign_subject_id)->where('exam_type_id',$request->exam_type_id)->delete();

...
<div class="box bb-3 border-warning">
		...
		<form method="post" action="{{ route('marks.entry.update') }}" autocomplete="off">
			@csrf
			<div class="row">
     ...
     $.ajax({
      ...
      success: function (data) {
        ...
        $.each( data, function(key, v){
          ...
          '<td><input type="text" class="form-control form-control-sm" name="homework[]" value=" '+v.dt +' " ></td>'+
          '<td><input type="text" class="form-control form-control-sm" name="test[]" value=" '+v.tt +' " ></td>'+
          '<td><input type="text" class="form-control form-control-sm" name="f_exam[]" value=" '+v.ef +' " ></td>'+
          '</tr>';
        });

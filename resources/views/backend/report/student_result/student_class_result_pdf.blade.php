   ...
   <span style="font-weight: bold">  7 Jan - 14 Fév 2020 </span>
    ...
    <tbody>
      ...
      <tr >
        ...
        <td  class="td" style="width:2px !important; border-bottom: 1px solid #fff"></td>
    ...
    <tfoot>
      <tr >
        ...
        <td  class="td" colspan="2" align="center" ><b>{{$sumofMarks->where('student_id', $student->student_id)->sum('total')}}</b></td><br>
        <tr>

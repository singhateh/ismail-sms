...
Route::get('get/marks/values', [MarksController::class, 'GetMarksValues'])->name('marks.get.marks');  

Route::get('get/marks/validate', [MarksController::class, 'GetMarksValidate'])->name('marks.get.marksvalidate');  
